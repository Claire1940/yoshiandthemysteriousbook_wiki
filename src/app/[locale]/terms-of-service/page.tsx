...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Yoshi and the Mysterious Book Wiki",
    description: "Read the Terms of Service for Yoshi and the Mysterious Book Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Nintendo Switch 2 game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Yoshi and the Mysterious Book Wiki",
      description: "Terms and conditions for using Yoshi and the Mysterious Book Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Yoshi and the Mysterious Book Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Yoshi and the Mysterious Book Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Yoshi and the Mysterious Book Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Yoshi and the Mysterious Book Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Nintendo Switch 2 game "Yoshi and the Mysterious Book". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Chapter guides and storybook progression references</li>
              <li>Collectibles and discoveries guides</li>
              <li>Creature and habitat information</li>
              <li>Character, release, and platform references</li>
              <li>Official-link roundups and community resources</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Yoshi and the Mysterious Book Wiki is NOT affiliated with, endorsed by, or associated with
              Nintendo Co., Ltd. and Nintendo of America Inc. or the official developers of Yoshi and the Mysterious Book. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Yoshi and the Mysterious Book Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Nintendo Co., Ltd. and Nintendo of America Inc. and/or the developers of Yoshi and the Mysterious Book. We use such
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, YOSHI AND THE MYSTERIOUS BOOK WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              The Website may contain links to third-party websites, including Nintendo and social media platforms,
            ...
            <p>
              ...
              you and Yoshi and the Mysterious Book Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@yoshiandthemysteriousbook.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@yoshiandthemysteriousbook.wiki</a>
            </p>
            <p>
