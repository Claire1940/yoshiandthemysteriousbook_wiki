...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Yoshi and the Mysterious Book Wiki',
    description: 'Copyright and intellectual property information for Yoshi and the Mysterious Book Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Yoshi and the Mysterious Book Wiki',
      description: 'Copyright and intellectual property information for Yoshi and the Mysterious Book Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Yoshi and the Mysterious Book Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Yoshi and the Mysterious Book Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Yoshi and the Mysterious Book Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Nintendo</strong> - Owner of Nintendo platforms and related trademarks</li>
              <li><strong>Yoshi and the Mysterious Book Developers</strong> - Creators of the Yoshi and the Mysterious Book game</li>
            </ul>
            <p>
            ...
            <ul>
              <li><strong>NINTENDO</strong> - Trademark of Nintendo Co., Ltd. and Nintendo of America Inc.</li>
              <li><strong>Yoshi and the Mysterious Book</strong> - Trademark of the game developers</li>
              <li><strong>Yoshi and the Mysterious Book Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Yoshi and the Mysterious Book Wiki.
            </p>
            ...
            <p>
              ...
              Yoshi and the Mysterious Book Wiki<br />
              Email: <a href="mailto:dmca@yoshiandthemysteriousbook.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@yoshiandthemysteriousbook.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Yoshi and the Mysterious Book Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Yoshi and the Mysterious Book Wiki (yoshiandthemysteriousbook.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@yoshiandthemysteriousbook.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@yoshiandthemysteriousbook.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@yoshiandthemysteriousbook.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@yoshiandthemysteriousbook.wiki</a>
            </p>
            <p>
