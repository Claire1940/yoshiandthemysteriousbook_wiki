...
export default function HomePageClient({
    ...
    "@graph": [
      {
        ...
        "@id": `${siteUrl}/#website`,
        url: siteUrl,
        name: "Yoshi and the Mysterious Book Wiki",
        description:
          "Complete Yoshi and the Mysterious Book Wiki with chapter guides, creature discoveries, collectibles, and Nintendo Switch 2 release details.",
        image: {
          "@type": "ImageObject",
          url: `${siteUrl}/images/hero.webp`,
          width: 1920,
          height: 1080,
          caption: "Yoshi and the Mysterious Book - Storybook discovery adventure",
        },
        potentialAction: {
          "@type": "SearchAction",
      ...
      },
      {
        ...
        name: "Yoshi and the Mysterious Book Wiki",
        alternateName: "Yoshi and the Mysterious Book",
        url: siteUrl,
        description:
          "Resource hub for Yoshi and the Mysterious Book guides, chapters, creatures, discoveries, and collectibles.",
        logo: {
          "@type": "ImageObject",
        ...
        image: {
          ...
          width: 1920,
          height: 1080,
          caption: "Yoshi and the Mysterious Book Wiki - Storybook discoveries and chapter guides",
        },
        sameAs: [
          "https://www.nintendo.com/us/store/products/yoshi-and-the-mysterious-book-switch-2/",
          "https://www.youtube.com/@NintendoAmerica",
          "https://x.com/NintendoAmerica",
          "https://www.instagram.com/NintendoAmerica/",
        ],
      },
      {
        "@type": "VideoGame",
        ...
        offers: {
          ...
          url: "https://www.nintendo.com/us/store/products/yoshi-and-the-mysterious-book-switch-2/",
        },
      },
      {
        "@type": "VideoObject",
        name: "Yoshi and the Mysterious Book – Overview Trailer – Nintendo Switch 2",
        description:
  ...
  return (
    <div className="home-shell min-h-screen bg-background text-foreground">
        ...
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-8 scroll-reveal">
            ...
            <div className="mb-10 flex flex-col justify-center gap-3 sm:flex-row md:mb-12 md:gap-4">
              ...
              >
                {t.hero.playOnNintendoCTA || "Buy on Nintendo"}
      ...
      <section className="px-4 py-14 md:py-20 bg-white/[0.02]">
        <div className="container mx-auto max-w-5xl">
          ...
          <nav className="sr-only" aria-hidden="true">
            ...
            <a href="#creature-discovery-guide">creature-discovery-guide</a>
            <a href="#smiley-flower-locations">smiley-flower-locations</a>
            <a href="#controls-moves">controls-moves</a>
            <a href="#release-platform">release-platform</a>
            <a href="#bosses-characters">bosses-characters</a>
            <a href="#review-buying-guide">review-buying-guide</a>
          </nav>
      ...
      <section id="beginner-guide" className="scroll-mt-24 px-4 py-14 md:py-20">
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-8 md:mb-12 scroll-reveal">
            <h2 className="text-3xl md:text-5xl font-bold mb-3 md:mb-4">
              <LinkedTitle
                linkData={moduleLinkMap["yoshiBeginnerGuide"]}
                locale={locale}
              >
                {t.modules.yoshiBeginnerGuide.title}
              </LinkedTitle>
            </h2>
            <p className="text-base md:text-lg text-muted-foreground max-w-3xl mx-auto">
              {t.modules.yoshiBeginnerGuide.intro}
            </p>
          </div>

          {/* Steps */}
          <div className="scroll-reveal space-y-3 md:space-y-4 mb-8 md:mb-10">
            {t.modules.yoshiBeginnerGuide.steps.map(
                  ...
                  <div>
                    <h3 className="text-lg md:text-xl font-bold mb-1.5 md:mb-2">
                      <LinkedTitle
                        linkData={
                          moduleLinkMap[
                            `yoshiBeginnerGuide::steps::${index}`
                          ]
                        }
                        locale={locale}
                      >
          ...
          <div className="scroll-reveal p-4 md:p-6 bg-[hsl(var(--nav-theme)/0.05)] border border-[hsl(var(--nav-theme)/0.3)] rounded-xl">
            ...
            <ul className="space-y-2">
              {t.modules.yoshiBeginnerGuide.quickTips.map(
        ...
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-12 scroll-reveal">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">
              <LinkedTitle
                linkData={moduleLinkMap["yoshiWalkthrough"]}
                locale={locale}
              >
                {t.modules.yoshiWalkthrough.title}
              </LinkedTitle>
            </h2>
            <p className="text-muted-foreground text-lg max-w-3xl mx-auto">
              {t.modules.yoshiWalkthrough.intro}
            </p>
          </div>
          <div className="scroll-reveal grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
            {t.modules.yoshiWalkthrough.cards.map(
          ...
          <div className="scroll-reveal flex flex-wrap gap-3 justify-center">
            {t.modules.yoshiWalkthrough.milestones.map(
              (m: string, i: number) => (
                <span
                  key={i}
      ...
      {/* Module 3: Creature Discovery Guide */}
      <section id="creature-discovery-guide" className="scroll-mt-24 px-4 py-20">
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-12 scroll-reveal">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">
              <LinkedTitle
                linkData={moduleLinkMap["yoshiCreatureDiscoveryGuide"]}
                locale={locale}
              >
                {t.modules.yoshiCreatureDiscoveryGuide.title}
              </LinkedTitle>
            </h2>
            <p className="text-muted-foreground text-lg max-w-3xl mx-auto">
              {t.modules.yoshiCreatureDiscoveryGuide.intro}
            </p>
          </div>
          <div className="scroll-reveal grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {t.modules.yoshiCreatureDiscoveryGuide.items.map(
                ...
                >
                  ...
                  <h3 className="font-bold mb-2">
                    <LinkedTitle
                      linkData={
                        moduleLinkMap[
                          `yoshiCreatureDiscoveryGuide::items::${index}`
                        ]
                      }
                      locale={locale}
                    >
      ...
      {/* Module 4: Smiley Flower Locations */}
      <section id="smiley-flower-locations" className="scroll-mt-24 px-4 py-20 bg-white/[0.02]">
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-12 scroll-reveal">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">
              <LinkedTitle
                linkData={moduleLinkMap["yoshiSmileyFlowerLocations"]}
                locale={locale}
              >
                {t.modules.yoshiSmileyFlowerLocations.title}
              </LinkedTitle>
            </h2>
            <p className="text-muted-foreground text-lg max-w-3xl mx-auto">
              {t.modules.yoshiSmileyFlowerLocations.intro}
            </p>
          </div>
          <div className="scroll-reveal grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
            {t.modules.yoshiSmileyFlowerLocations.solutions.map(
              (s: any, index: number) => (
                <div
                  key={index}
                  className="p-6 bg-white/5 border border-border rounded-xl hover:border-[hsl(var(--nav-theme)/0.5)] transition-colors"
                  ...
                  <div className="flex items-center gap-2 mb-3">
                    <h3 className="font-bold">
                      <LinkedTitle
                        linkData={
                          moduleLinkMap[
                            `yoshiSmileyFlowerLocations::solutions::${index}`
                          ]
                        }
                        locale={locale}
                      >
          ...
          <div className="scroll-reveal p-6 bg-[hsl(var(--nav-theme)/0.05)] border border-[hsl(var(--nav-theme)/0.3)] rounded-xl">
            ...
            <ul className="space-y-2">
              {t.modules.yoshiSmileyFlowerLocations.managementTips.map(
                (tip: string, i: number) => (
      ...
      {/* Module 5: Controls and Moves */}
      <section id="controls-moves" className="scroll-mt-24 px-4 py-20 bg-white/[0.02]">
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-12 scroll-reveal">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">
              <LinkedTitle
                linkData={moduleLinkMap["yoshiControlsAndMoves"]}
                locale={locale}
              >
      ...
      {/* Module 6: Release Date and Platform */}
      <section id="release-platform" className="scroll-mt-24 px-4 py-20">
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-12 scroll-reveal">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">
              <LinkedTitle
                linkData={moduleLinkMap["yoshiReleaseDateAndPlatform"]}
                locale={locale}
              >
      ...
      {/* Module 7: Bosses and Characters */}
      <section id="bosses-characters" className="scroll-mt-24 px-4 py-20 bg-white/[0.02]">
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-12 scroll-reveal">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">
              <LinkedTitle
                linkData={moduleLinkMap["yoshiBossesAndCharacters"]}
                locale={locale}
              >
      ...
      {/* Module 8: Review and Buying Guide */}
      <section id="review-buying-guide" className="scroll-mt-24 px-4 py-20">
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-12 scroll-reveal">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">
              <LinkedTitle
                linkData={moduleLinkMap["yoshiReviewAndBuyingGuide"]}
                locale={locale}
              >
                ...
                >
                  ...
                  <h3 className="font-bold mb-2">
                    <LinkedTitle
                      linkData={
                        moduleLinkMap[
                          `yoshiReviewAndBuyingGuide::items::${index}`
                        ]
                      }
                      locale={locale}
                    >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  <a
                    href="https://www.youtube.com/@NintendoAmerica"
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <li>
                  <a
                    href="https://x.com/NintendoAmerica"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-muted-foreground hover:text-[hsl(var(--nav-theme-light))] transition"
                  >
                ...
                <li>
                  <a
                    href="https://www.reddit.com/r/YosHi/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-muted-foreground hover:text-[hsl(var(--nav-theme-light))] transition"
                  >
